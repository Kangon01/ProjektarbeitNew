...
/************************************************************************
 *  @fn     MV_CC_SaveImage
 *  @brief  ����ͼƬ���ýӿڽ�֧��Windows�������ã�������� MV_CC_SaveImageEx2�ӿڣ�
 ...
 *  @brief  ����ͼƬ��֧��Bmp��Jpeg.����������50-99֮ǰ ���ýӿڽ�֧��Windows�������ã�������� MV_CC_SaveImageEx2�ӿڣ�
 *  @param  pSaveParam             [IN][OUT]          ����ͼƬ�����ṹ��
                       pData;              // [IN]     �������ݻ���
                       nDataLen;           // [IN]     �������ݴ�С
                       enPixelType;        // [IN]     �������ݵ����ظ�ʽ
 ...
 *  @brief  ע���¼��ص����ýӿ������ã�������� MV_CC_RegisterEventCallBackEx�ӿڣ����ýӿ�ֻ֧�������豸����֧��U�ں�GenTL�豸
 *  @param  handle���豸���
 ...
 *  @return Success, return MV_OK. Failure, return error code
 ************************************************************************/
MV_CAMCTRL_API const char *__stdcall MV_CC_TriggerSoftwareExecute(IN void *handle);
